...
base_url = "https://www.moneycontrol.com/stocks/company_info/stock_news.php?sc_id=RI&scat=&pageno={}&next=0&durationType=Y&Year={}&duration=1&news_type="
...
with open('reliancenews.csv', 'w', newline='', encoding='utf-8') as file:
